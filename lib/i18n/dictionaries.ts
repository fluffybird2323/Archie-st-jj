export const dictionaries = {
  en: {
    ...
    checkout: {
      ...
      loading: {
        ...
        pleaseWait: "Please wait while we set up your secure payment",
  ...
  "zh-CN": {
    ...
    checkout: {
      ...
      errors: {
        ...
        firstNameRequired: "姓名为必填项",
        lastNameRequired: "姓氏为必填项",
        addressRequired: "街道地址为必填项",
        cityRequired: "城市为必填项",
        stateRequired: "省/直辖市为必填项",
        postalCodeRequired: "邮政编码为必填项",
      },
      loading: {
        preparingCheckout: "准备安全结账",
        redirecting: "正在跳转到支付页面",
        pleaseWait: "请稍候，我们正在设置您的安全支付",
        doNotClose: "请勿关闭或刷新此页面",
      },
    },
    success: {
      title: "订单成功！",
  ...
  ja: {
    ...
    checkout: {
      ...
      loading: {
        preparingCheckout: "安全なチェックアウトを準備中",
        redirecting: "支払いページにリダイレクト中",
        pleaseWait: "安全な決済の設定中です。お待ちください",
        doNotClose: "このページを閉じたり更新したりしないでください",
      },
    },
    success: {
      title: "注文完了！",
  ...
  de: {
    ...
    checkout: {
      ...
      loading: {
        preparingCheckout: "Sicheren Checkout vorbereiten",
        redirecting: "Weiterleitung zur Zahlungsseite",
        pleaseWait: "Bitte warten Sie, während wir Ihre sichere Zahlung einrichten",
        doNotClose: "Schließen oder aktualisieren Sie diese Seite nicht",
      },
    },
    success: {
  ...
  fr: {
    ...
    checkout: {
      ...
      errors: {
        ...
        stateRequired: "La région/province est obligatoire",
      ...
      loading: {
        ...
        pleaseWait: "Veuillez patienter pendant que nous configurons votre paiement sécurisé",
        doNotClose: "Ne fermez pas et ne rafraîchissez pas cette page",
      },
    },
    success: {
  ...
  es: {
    ...
    checkout: {
      ...
      loading: {
        ...
        pleaseWait: "Por favor espera mientras configuramos tu pago seguro",
  ...
  it: {
    ...
    checkout: {
      ...
      errors: {
        ...
        stateRequired: "La provincia è obbligatoria",
      ...
      loading: {
        ...
        pleaseWait: "Attendere mentre configuriamo il pagamento sicuro",
        doNotClose: "Non chiudere o aggiornare questa pagina",
      },
    },
    success: {
