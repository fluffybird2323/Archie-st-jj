    ...
    <div className="relative w-full h-screen overflow-hidden bg-light-50">
      ...
      <div className="absolute inset-0 bg-white bg-opacity-20 flex flex-col items-center justify-center">
        <div className="text-center max-w-4xl px-4">
          <h1 className="text-6xl md:text-8xl font-black tracking-tight text-black mb-6 animate-fade-in">JUST DO IT</h1>
          <p className="text-xl md:text-2xl text-gray-700 mb-12 font-light">Premium streetwear that moves with you</p>
